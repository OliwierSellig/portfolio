...
function Description() {
  return (
    <StyledDescription>
      ...
      <AboutText>
        I&apos;m a self-taught{" "}
        <HighlightText>Front-end Developer</HighlightText> from Poland. My joy
        has always come from creating things, and my computer has been my trusty
        sidekick. So, I thought, why not bring these two passions together? And
        here I am, channeling my creativity into designing and building
        websites. Feel free to take a look at my projects and reach out to
        connect!
      </AboutText>
      <CtaContainer>
        <CustomButton
