...
import { ProjectItem, TechnologyItem } from "../../lib/types";
...
const Container = styled.li<ContainerProps>`
  ...
  background-image: ${(props) =>
    `url("${props.$cover?.md || "../../../public/img/tbm-l.webp"}")`};
  ${backgroundCenter}
  ...
  @media only screen and (max-width: 440px),
    ...
    background-image: ${(props) =>
      `url("${props.$cover?.sm || "../../../public/img/tbm-s.webp"}")`};
  }
`;
